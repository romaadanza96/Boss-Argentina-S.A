...
ciudad = document.getElementById("city4").value;
prov = document.getElementById("provincia4").value;
telefono = document.getElementById("phone4").value;
correo = document.getElementById("exampleInputEmail14").value;
empresa = document.getElementById("company4").value;
expresion = /\w+@\w+\.+[a-z]/;
